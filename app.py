...
def user_input():
    if request.method == "POST":
        try:
            ...
            language = request.form.get("language") # retrieve language
...
def newPrompt_ChatGPT():
    if request.method == "POST":
        try:
            ...
            message = ChatGPT_advanced_search(user_input, language)
            # print("------>", language)
